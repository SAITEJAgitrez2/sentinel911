...
# Make sure to install: pip install transformers torch

# Zero-shot classification model for urgency & deception
zero_shot_model = pipeline("zero-shot-classification", model="facebook/bart-large-mnli")

# Sentiment analysis (optional, can assist deception estimation)
...
def analyze_call(transcript: str) -> dict:
    try:
        ...
        # Heuristic: use top score only if it's clearly dominant
